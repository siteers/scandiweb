...
<form method='POST'>Type switcher:
        ...
        <option name="DVD-disc">DVD-disc</option>
...
<form id='product_form' method='POST'>    
        <br><br>
        <a href='index.php'><h2 class='h2'><input type="submit" name="submit1" value="Save" class="button"></h2></a>
...
if(isset($_POST['submit20'])){
    ...
    {if(isset($_POST['switcher']) == "DVD-disc") 
    {if($_POST['switcher']=="DVD-disc"){
